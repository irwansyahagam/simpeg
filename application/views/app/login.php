  ...
  <body>
            ...
            <ul class="nav">
			  ...
			  <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#"><i class="icon-asterisk"></i>Pegawai</a></li>
                </ul>
              </li>
            </ul>
	...
	<?php } ?>
      <div class="hero-unit">
        ...
        <p>Sistem Informasi Kepegawaian merupakan sebuah aplikasi untuk melakukan manajemen data kepegawaian untuk pegawai negeri sipil (PNS) 
        di Aceh. Silahkan masukkan username dan password anda untuk mulai untuk 
        melakukan manajemen atau pengolahan data kepegawaian sesuai dengan hak akses yang anda miliki.</p>
